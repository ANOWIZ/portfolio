...
const projects = [
  {
    ...
    description: 'Сервис для выбора поставщиков кофе и чая в Екатеринбурге и Москве. Собрал условия 10 компаний с официальных сайтов, чтобы сравнивать варианты перед запросом коммерческого предложения.',
    details: ['Выбор категории, города, объёма и периода закупки.', 'Сравнение до трёх поставщиков, запрос и выгрузка в CSV.', 'Источники данных, неизвестные условия и объяснение оценки.'],
      ...
      <main id="top">
        <section className="hero">
          ...
          <a className="featured-link" href="https://anowiz.github.io/supplier-scout/">
            ...
            <strong>Выбор поставщиков кофе и чая</strong>
        ...
        <section className="approach section" id="approach">
          ...
          <ol className="approach-track">
            ...
            <li><h3>Планирую проверку</h3><p>Определяю, какой сценарий показать пользователю и по каким признакам оценить пользу прототипа.</p></li>
          </ol>
        </section>
